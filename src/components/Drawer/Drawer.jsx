...
export const Drawer = () => {
    ...
    return (
        <div className="drawer" style={{ height: "100vh", display: "flex" }}>
            <div className="drawer__container">
                ...
                <div className="drawer__list">
                    {user.role !== 'engineer' && <NavLink to="/requests" className="drawer__link">Обращения</NavLink>}
                    <NavLink to="/calendar" className="drawer__link">Календарь</NavLink>
                    {user.role !== 'engineer' && <NavLink to="/statistics" className="drawer__link">Статистика</NavLink>}
                    {user.role !== 'engineer' && <NavLink to="/workers" className="drawer__link">Список сотрудников</NavLink>}
                    {user.role === 'engineer' && <NavLink to="/statistics" className="drawer__link">Список заявок</NavLink>}
                </div>
                <div className="drawer__user">
                    ...
                    <div className="drawer__user__logout" onClick={handleLogout}>
                        <svg
